...
caseFun.moveFun = function() { //文字框移动
    ...
    $(".j-list-case li").bind("mouseenter mouseleave", function(e) {
        ...
        if (e.type == 'mouseenter') {
            ...
            $(this).children("img").animate({width:"114%",height:"112%",marginTop:"-6%",marginLeft:"-6%"},100, 'easeOutSine');

        } else {
            moveOut(objTxt, direction);
            $(this).children("img").animate({width:"100%",height:"100%",marginTop:"0",marginLeft:"0"},100, 'easeOutSine');
        }
    });
